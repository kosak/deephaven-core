...
public final class HMLFnomodK2V2 extends HMLFnomodK2V2Base implements NullableLongLongMapTestAccessors {
    private volatile long[] keysAndValues;

    public HMLFnomodK2V2() {
        this(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, DEFAULT_NO_ENTRY_VALUE);
    }

    public HMLFnomodK2V2(int desiredInitialCapacity) {
        this(desiredInitialCapacity, DEFAULT_LOAD_FACTOR, DEFAULT_NO_ENTRY_VALUE);
    }

    HMLFnomodK2V2(int desiredInitialCapacity, float loadFactor) {
        this(desiredInitialCapacity, loadFactor, DEFAULT_NO_ENTRY_VALUE);
    }

    public HMLFnomodK2V2(int desiredInitialCapacity, float loadFactor, long noEntryValue) {
