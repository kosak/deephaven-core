...
public final class HMLFamacK4V4 extends HMLFamacK4V4Base implements NullableLongLongMapTestAccessors {
    ...
    public HMLFamacK4V4(int desiredInitialCapacity) {
        this(desiredInitialCapacity, DEFAULT_LOAD_FACTOR, DEFAULT_NO_ENTRY_VALUE);
    }

    HMLFamacK4V4(int desiredInitialCapacity, float loadFactor) {
        this(desiredInitialCapacity, loadFactor, DEFAULT_NO_ENTRY_VALUE);
    }

    public HMLFamacK4V4(int desiredInitialCapacity, float loadFactor, long noEntryValue) {
