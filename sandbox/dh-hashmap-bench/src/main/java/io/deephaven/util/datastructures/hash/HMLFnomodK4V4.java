...
public final class HMLFnomodK4V4 extends HMLFnomodK4V4Base implements NullableLongLongMapTestAccessors {
    private volatile long[] keysAndValues;

    public HMLFnomodK4V4() {
        this(DEFAULT_INITIAL_CAPACITY, DEFAULT_LOAD_FACTOR, DEFAULT_NO_ENTRY_VALUE);
    }

    public HMLFnomodK4V4(int desiredInitialCapacity) {
        this(desiredInitialCapacity, DEFAULT_LOAD_FACTOR, DEFAULT_NO_ENTRY_VALUE);
    }

    HMLFnomodK4V4(int desiredInitialCapacity, float loadFactor) {
        this(desiredInitialCapacity, loadFactor, DEFAULT_NO_ENTRY_VALUE);
    }

    public HMLFnomodK4V4(int desiredInitialCapacity, float loadFactor, long noEntryValue) {
