...
public final class HMLFamacK1V1 extends HMLFamacK1V1Base implements NullableLongLongMapTestAccessors {
    ...
    public HMLFamacK1V1(int desiredInitialCapacity) {
        this(desiredInitialCapacity, DEFAULT_LOAD_FACTOR, DEFAULT_NO_ENTRY_VALUE);
    }

    HMLFamacK1V1(int desiredInitialCapacity, float loadFactor) {
        this(desiredInitialCapacity, loadFactor, DEFAULT_NO_ENTRY_VALUE);
    }

    public HMLFamacK1V1(int desiredInitialCapacity, float loadFactor, long noEntryValue) {
