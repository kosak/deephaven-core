...
//      std::vector<Aggregate> aggregations) const;
  ...
  /**
   * The RangeJoin method creates a new table containing all the rows and columns of the left table,
   ...
   *
   * RangeJoin is a join plus aggregation that (1) joins arrays of data from the right table onto the left table,
