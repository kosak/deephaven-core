...
class FigureDescriptor_MultiSeriesSourceDescriptor final :
 ...
 public:
  ...
  int32_t table_map_id() const;
  void set_table_map_id(int32_t value);
  private:
  int32_t _internal_table_map_id() const;
  void _internal_set_table_map_id(int32_t value);
  public:
...
inline std::string* FigureDescriptor_StringMapWithDefault::release_default_string() {
  ...
  return default_string_.Release();
}
...
inline int32_t FigureDescriptor_MultiSeriesSourceDescriptor::_internal_table_map_id() const {
  return table_map_id_;
}
inline int32_t FigureDescriptor_MultiSeriesSourceDescriptor::table_map_id() const {
...
inline void FigureDescriptor_MultiSeriesSourceDescriptor::_internal_set_table_map_id(int32_t value) {
  
  table_map_id_ = value;
}
inline void FigureDescriptor_MultiSeriesSourceDescriptor::set_table_map_id(int32_t value) {
...
inline int32_t FigureDescriptor_SourceDescriptor::_internal_table_map_id() const {
  return table_map_id_;
}
inline int32_t FigureDescriptor_SourceDescriptor::table_map_id() const {
  // @@protoc_insertion_point(field_get:io.deephaven.proto.backplane.script.grpc.FigureDescriptor.SourceDescriptor.table_map_id)
  return _internal_table_map_id();
}
inline void FigureDescriptor_SourceDescriptor::_internal_set_table_map_id(int32_t value) {
  
  table_map_id_ = value;
}
inline void FigureDescriptor_SourceDescriptor::set_table_map_id(int32_t value) {
  _internal_set_table_map_id(value);
