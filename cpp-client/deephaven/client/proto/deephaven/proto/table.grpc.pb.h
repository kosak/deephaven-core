...
class TableService final {
 public:
  ...
  template <class BaseClass>
  class WithCallbackMethod_FetchTableMap : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithCallbackMethod_FetchTableMap() {
      ::grpc::Service::MarkMethodCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::io::deephaven::proto::backplane::grpc::FetchTableMapRequest, ::io::deephaven::proto::backplane::grpc::FetchTableMapResponse>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::io::deephaven::proto::backplane::grpc::FetchTableMapRequest* request, ::io::deephaven::proto::backplane::grpc::FetchTableMapResponse* response) { return this->FetchTableMap(context, request, response); }));}
    void SetMessageAllocatorFor_FetchTableMap(
        ::grpc::MessageAllocator< ::io::deephaven::proto::backplane::grpc::FetchTableMapRequest, ::io::deephaven::proto::backplane::grpc::FetchTableMapResponse>* allocator) {
    ...
    ~WithCallbackMethod_FetchTableMap() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchTableMap(::grpc::ServerContext* /*context*/, const ::io::deephaven::proto::backplane::grpc::FetchTableMapRequest* /*request*/, ::io::deephaven::proto::backplane::grpc::FetchTableMapResponse* /*response*/) override {
    ...
    virtual ::grpc::ServerUnaryReactor* FetchTableMap(
      ::grpc::CallbackServerContext* /*context*/, const ::io::deephaven::proto::backplane::grpc::FetchTableMapRequest* /*request*/, ::io::deephaven::proto::backplane::grpc::FetchTableMapResponse* /*response*/)  { return nullptr; }
  };
  template <class BaseClass>
  ...
  template <class BaseClass>
  class WithRawCallbackMethod_FetchTableMap : public BaseClass {
   private:
    void BaseClassMustBeDerivedFromService(const Service* /*service*/) {}
   public:
    WithRawCallbackMethod_FetchTableMap() {
      ::grpc::Service::MarkMethodRawCallback(3,
          new ::grpc::internal::CallbackUnaryHandler< ::grpc::ByteBuffer, ::grpc::ByteBuffer>(
            [this](
                   ::grpc::CallbackServerContext* context, const ::grpc::ByteBuffer* request, ::grpc::ByteBuffer* response) { return this->FetchTableMap(context, request, response); }));
    }
    ~WithRawCallbackMethod_FetchTableMap() override {
      BaseClassMustBeDerivedFromService(this);
    }
    // disable synchronous version of this method
    ::grpc::Status FetchTableMap(::grpc::ServerContext* /*context*/, const ::io::deephaven::proto::backplane::grpc::FetchTableMapRequest* /*request*/, ::io::deephaven::proto::backplane::grpc::FetchTableMapResponse* /*response*/) override {
