...
PlatformUtf16v2 PlatformUtf16v2::Create(std::string_view s) {
  Utf16Converter c;
...
void PlatformUtf16v2::CreateBulk(const std::string *strings, size_t num_strings,
    PlatformUtf16v2 *results) {
  Utf16Converter c;
...
void PlatformUtf16v2::CreateBulk(const std::u16string *strings, size_t num_strings,
    PlatformUtf16v2 *results) {
