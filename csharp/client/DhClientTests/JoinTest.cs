...
public class JoinTest {
  ...
  public void TestJoin() {
    ...
    var table = testTable.Where("ImportDate == `2017-11-01`");
    var lastClose = table.LastBy("Ticker");
    var avgView = table.View("Ticker", "Volume").AvgBy("Ticker");

    var joined = lastClose.NaturalJoin(avgView, new[] {"Ticker"}, new[]{ "ADV = Volume"});

    var filtered = joined.Select("Ticker", "Close", "ADV");
