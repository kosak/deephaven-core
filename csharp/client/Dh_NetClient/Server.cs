...
//
    ...
    var sendTime = DateTime.Now;
    {
      ...
      var serverMetadata = ccTask.ResponseHeadersAsync.ConfigureAwait(false).GetAwaiter().GetResult();
      var ccResp = ccTask.ResponseAsync.ConfigureAwait(false).GetAwaiter().GetResult();
  ...
  private TResponse SendRpcUnchecked<TResponse>(
    ...
    var serverMetadata = asyncResp.ResponseHeadersAsync.ConfigureAwait(false).GetAwaiter().GetResult();
    var result = asyncResp.ResponseAsync.ConfigureAwait(false).GetAwaiter().GetResult();
