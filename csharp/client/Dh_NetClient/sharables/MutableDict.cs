...
public class MutableDict<TValue> : IDictionary<Int64, TValue> {
  public MutableDict() {
    _root = SharableDict<TValue>.Empty.RootForUnitTests;
  }

  private readonly EitherNode<EitherNode<EitherNode<EitherNode<EitherNode<
    EitherNode<EitherNode<EitherNode<EitherNode<EitherNode<
      EitherLeaf<TValue>>>>>>>>>>> _root;

  /// <summary>
  /// Constructor. Used internally.
  /// </summary>
  /// <param name="root"></param>
  internal MutableDict(
    EitherNodeOrLeaf<EitherNodeOrLeaf<EitherNodeOrLeaf<EitherNodeOrLeaf<EitherNodeOrLeaf<
      EitherNodeOrLeaf<EitherNodeOrLeaf<EitherNodeOrLeaf<EitherNodeOrLeaf<EitherNodeOrLeaf<
        EitherLeaf<TValue>>>>>>>>>>> root) {
    _root = root;
  }
